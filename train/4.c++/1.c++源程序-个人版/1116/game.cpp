...
int Game::run(){
     ...
     */
    /*
       set_point_num(24,7,0);//帽子坐标
       set_point_num(36,7,0);//衬衣坐标
       set_point_num(48,7,0);//裤子坐标

       set_point_num(24,11,0);//腰带坐标
       set_point_num(36,11,0);//鞋子坐标
       set_point_num(48,11,0);//武器坐标

       set_point_num(24,15,0);//红药坐标
       set_point_num(36,15,0);//蓝药坐标
       set_point_num(48,15,0);//经验坐标

       set_point_num(24,19,0);//a坐标
       set_point_num(24,20,0);//b坐标
       set_point_num(24,21,0);//c坐标
       set_point_num(24,22,0);//d坐标
       set_point_num(24,23,0);//e坐标


       set_point_num(62,8,0);//A坐标
       set_point_num(62,9,0);//B坐标
       set_point_num(62,10,0);//C坐标
       set_point_num(62,11,0);//D坐标
       set_point_num(62,12,0);//E坐标
       set_point_num(62,13,0);//F坐标
       set_point_num(62,14,0);//G坐标
       set_point_num(62,15,0);//H坐标
       set_point_num(62,16,0);//I坐标
       set_point_num(62,17,0);//J坐标
       set_point_num(62,18,0);//K坐标
       set_point_num(62,19,0);//L坐标
     */
    //    while(1);
    /*
       char a[10]="1001q";
...
void Game::test(){
    HAT hat(5,10,"紫金头盔","增加护甲与攻速",60,100,40,2000,4000,30,Senior,Gold,1);
    WEAPON weap(10,50,"狙击步枪","增加攻击与攻速",0.7,300,100,3000,6500,55,Fame,Gold,1);
    DRUG drug(15,25,"死者苏醒","增加大量生命值",500,7000,60,Artifact,Gold,1);
    hat.show();
    cout<<"-------------------------------------------------------"<<endl;
    weap.show();
    cout<<"-------------------------------------------------------"<<endl;
