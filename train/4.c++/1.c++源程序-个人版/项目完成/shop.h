...
class Attribute{
    ...
    Attribute() : Attribute(2000,800,5,5,300,150,220,90,0,Common,Gold){}
...
extern PARTS input_part(char n);
extern TYPE input_type(char n);
extern WEALTH input_wealth(char n);
extern RARE input_rare(char n);
#endif
