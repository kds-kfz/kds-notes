...
namespace Glacier2
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Glacier2::Router`.
...
#   pragma GCC diagnostic ignored "-Wextra" // initialize all virtual bases in correct order
        ...
        /// @see ::Glacier2::SessionPrx
        /// @see ::Glacier2::SessionManagerPrx
        /// @see ::Glacier2::PermissionsVerifierPrx
...
namespace Glacier2
{
    ...
    /// this client.
    /// @remarks The Slice compiler generated this exception class from Slice exception `::Glacier2::SessionNotExistException`.
    /// @see RouterPrx::destroySession
    /// @headerfile Glacier2/Glacier2.h
...
{
    /// The Glacier2 specialization of the ::Ice::RouterPrx interface.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::Router`.
    /// @headerfile Glacier2/Glacier2.h
...
namespace Glacier2
{
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::Router`.
    /// @headerfile Glacier2/Glacier2.h
    class GLACIER2_API AsyncRouter : public virtual ::Ice::AsyncRouter
    {
    public:
        /// The associated proxy type.
        using ProxyType = RouterPrx;
