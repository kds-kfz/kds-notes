...
namespace Ice
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Ice::Process`.
...
namespace Ice
{
    /// A server application managed by a locator implementation such as IceGrid hosts a Process object and registers a
    /// proxy to this object with the locator registry. See LocatorRegistryPrx::setServerProcessProxy.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::Process`.
    /// @headerfile Ice/Ice.h
...
namespace Ice
{
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::Process`.
    /// @headerfile Ice/Ice.h
    class ICE_API AsyncProcess : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = ProcessPrx;
    ...
    using AsyncProcessPtr = std::shared_ptr<AsyncProcess>;
}
