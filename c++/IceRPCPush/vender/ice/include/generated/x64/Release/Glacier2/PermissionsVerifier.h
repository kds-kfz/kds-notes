...
namespace Glacier2
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Glacier2::PermissionsVerifier`.
    ...
    public:
        ...
        /// @throws Glacier2::PermissionDeniedException Thrown when the user's access is denied. This exception can be thrown
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Glacier2::SSLPermissionsVerifier`.
    /// @headerfile Glacier2/Glacier2.h
...
namespace Glacier2
{
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::Glacier2::PermissionDeniedException`.
    /// @headerfile Glacier2/Glacier2.h
...
namespace Glacier2
{
    /// Represents an object that checks user permissions. The Glacier2 router and other services use a
    /// PermissionsVerifierPrx proxy when the user is authenticated using a user ID and password.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::PermissionsVerifier`.
    /// @headerfile Glacier2/Glacier2.h
    ...
    /// Represents an object that checks user permissions. The Glacier2 router and other services use an
    /// SSLPermissionsVerifierPrx proxy when the user is authenticated through an SSL certificate.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::SSLPermissionsVerifier`.
    /// @headerfile Glacier2/Glacier2.h
...
namespace Glacier2
{
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::PermissionsVerifier`.
    /// @headerfile Glacier2/Glacier2.h
    class GLACIER2_API AsyncPermissionsVerifier : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = PermissionsVerifierPrx;
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::SSLPermissionsVerifier`.
    /// @headerfile Glacier2/Glacier2.h
    class GLACIER2_API AsyncSSLPermissionsVerifier : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = SSLPermissionsVerifierPrx;
