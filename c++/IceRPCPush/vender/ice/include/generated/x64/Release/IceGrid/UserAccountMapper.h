...
namespace IceGrid
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::IceGrid::UserAccountMapper`.
...
namespace IceGrid
{
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::IceGrid::UserAccountNotFoundException`.
    /// @headerfile IceGrid/IceGrid.h
...
namespace IceGrid
{
    /// Maps user strings in server descriptors to actual user account names. You can configure the user account mapper
    /// of an IceGrid node with the property `IceGrid.Node.UserAccountMapper`.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceGrid::UserAccountMapper`.
    /// @headerfile IceGrid/IceGrid.h
...
namespace IceGrid
{
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceGrid::UserAccountMapper`.
    /// @headerfile IceGrid/IceGrid.h
    class ICEGRID_API AsyncUserAccountMapper : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = UserAccountMapperPrx;
