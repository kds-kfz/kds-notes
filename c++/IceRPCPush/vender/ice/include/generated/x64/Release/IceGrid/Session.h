...
namespace IceGrid
{
    ...
    /// either via the RegistryPrx object or via the registry client ::Glacier2::SessionManagerPrx object.
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::IceGrid::Session`.
...
#   pragma GCC diagnostic ignored "-Wextra" // initialize all virtual bases in correct order
        ...
        /// the registry.
        /// @see ::IceGrid::SessionPrx::setAllocationTimeout
        /// @see ::IceGrid::SessionPrx::releaseObject
...
namespace IceGrid
{
    /// Represents a session object used by IceGrid clients to allocate and release objects. Client sessions are created
    /// either via the RegistryPrx object or via the registry client ::Glacier2::SessionManagerPrx object.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceGrid::Session`.
    /// @headerfile IceGrid/IceGrid.h
    ...
    public:
        ...
        /// @see ::IceGrid::SessionPrx::setAllocationTimeout
        /// @see ::IceGrid::SessionPrx::releaseObject
        virtual std::optional<Ice::ObjectPrx> allocateObjectById(::Ice::Identity id, const Ice::Current& current) = 0;
        ...
        /// @see ::IceGrid::SessionPrx::setAllocationTimeout
        /// @see ::IceGrid::SessionPrx::releaseObject
        virtual std::optional<Ice::ObjectPrx> allocateObjectByType(std::string type, const Ice::Current& current) = 0;
...
namespace IceGrid
{
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceGrid::Session`.
    /// @headerfile IceGrid/IceGrid.h
    class ICEGRID_API AsyncSession : public virtual ::Glacier2::AsyncSession
    {
    public:
        /// The associated proxy type.
        using ProxyType = SessionPrx;
