...
namespace IceBox
{
    ...
    /// @see ServiceManagerPrx::addObserver
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::IceBox::ServiceManager`.
    /// @headerfile IceBox/IceBox.h
    ...
    public:
        ...
        /// @throws IceBox::NoSuchServiceException Thrown when IceBox does not know a service named @p service.
        bool isServiceRunning(std::string_view service, const Ice::Context& context = Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)
        ...
        [[nodiscard]] std::future<bool> isServiceRunningAsync(std::string_view service, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        /// @private
        void _iceI_isServiceRunning(const std::shared_ptr<IceInternal::OutgoingAsyncT<bool>>&, std::string_view, const Ice::Context&) const;
...
namespace IceBox
{
    ...
    /// Administers the services of an IceBox server.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceBox::ServiceManager`.
    /// @headerfile IceBox/IceBox.h
    ...
    public:
        ...
        /// @return `true` if the service was started and not stopped; otherwise `false`.
        /// @throws IceBox::NoSuchServiceException Thrown when IceBox does not know a service named @p service.
        virtual bool isServiceRunning(std::string service, const Ice::Current& current) = 0;

        /// @private
        void _iceD_isServiceRunning(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);
...
namespace IceBox
{
    ...
    /// @see ServiceManagerPrx::addObserver
    /// @headerfile IceBox/IceBox.h
    class ICEBOX_API AsyncServiceObserver : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = ServiceObserverPrx;
    ...
    using AsyncServiceObserverPtr = std::shared_ptr<AsyncServiceObserver>;

    /// Administers the services of an IceBox server.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceBox::ServiceManager`.
    /// @headerfile IceBox/IceBox.h
    class ICEBOX_API AsyncServiceManager : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = ServiceManagerPrx;
    ...
    using AsyncServiceManagerPtr = std::shared_ptr<AsyncServiceManager>;
}
