...
namespace Ice
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Ice::Router`.
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Ice::RouterFinder`.
    /// @headerfile Ice/Ice.h
...
namespace Ice
{
    /// Represents an intermediary object that routes requests and replies between clients and Ice objects that are not
    /// directly reachable from these clients.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::Router`.
    /// @headerfile Ice/Ice.h
    ...
    /// RouterFinder proxy `Ice/RouterFinder:tcp -h somehost -p 4061` to get the Router proxy
    /// `MyGlacier2/Router:tcp -h somehost -p 4061`.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::RouterFinder`.
    /// @headerfile Ice/Ice.h
...
namespace Ice
{
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::Router`.
    /// @headerfile Ice/Ice.h
    class ICE_API AsyncRouter : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = RouterPrx;
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::RouterFinder`.
    /// @headerfile Ice/Ice.h
    class ICE_API AsyncRouterFinder : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = RouterFinderPrx;
    ...
    using AsyncRouterFinderPtr = std::shared_ptr<AsyncRouterFinder>;
}
