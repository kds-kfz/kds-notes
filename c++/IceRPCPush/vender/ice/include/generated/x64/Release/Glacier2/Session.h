...
namespace Glacier2
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Glacier2::Session`.
    /// @see RouterPrx
    /// @see SessionManagerPrx
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Glacier2::StringSet`.
    /// @see SessionControlPrx
    /// @headerfile Glacier2/Glacier2.h
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Glacier2::IdentitySet`.
    /// @see SessionControlPrx
    /// @headerfile Glacier2/Glacier2.h
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Glacier2::SessionControl`.
    /// @see SessionManagerPrx
    /// @headerfile Glacier2/Glacier2.h
    ...
    public:
        ...
        /// @param context The request context.
        /// @return A proxy to a ::Glacier2::StringSetPrx object. This proxy is never null.
        ...
        /// @param context The request context.
        /// @return A proxy to an ::Glacier2::IdentitySetPrx object. This proxy is never null.
    ...
    /// its clients.
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Glacier2::SessionManager`.
    /// @headerfile Glacier2/Glacier2.h
    ...
    /// to its clients.
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Glacier2::SSLSessionManager`.
    /// @headerfile Glacier2/Glacier2.h
...
namespace Glacier2
{
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::Glacier2::CannotCreateSessionException`.
    /// @headerfile Glacier2/Glacier2.h
...
namespace Glacier2
{
    ...
    /// session is tied to the Ice connection between the client and the router: the session is destroyed when the
    /// connection is closed.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::Session`.
    /// @see RouterPrx
    /// @see SessionManagerPrx
    /// @headerfile Glacier2/Glacier2.h
    ...
    /// Manages a set of constraints on a SessionPrx.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::StringSet`.
    /// @see SessionControlPrx
    /// @headerfile Glacier2/Glacier2.h
    ...
    /// Manages a set of object identity constraints on a SessionPrx.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::IdentitySet`.
    /// @see SessionControlPrx
    /// @headerfile Glacier2/Glacier2.h
    ...
    /// Represents a router-provided object that allows an application-provided session manager to configure the
    /// routing constraints for a session.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::SessionControl`.
    /// @see SessionManagerPrx
    /// @headerfile Glacier2/Glacier2.h
    ...
    /// own SessionManager implementation; this router will then return the sessions created by this session manager to
    /// its clients.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::SessionManager`.
    /// @headerfile Glacier2/Glacier2.h
    ...
    /// own SSLSessionManager implementation; this router will then return the sessions created by this session manager
    /// to its clients.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::SSLSessionManager`.
    /// @headerfile Glacier2/Glacier2.h
...
namespace Glacier2
{
    ...
    /// @see SessionManagerPrx
    /// @headerfile Glacier2/Glacier2.h
    class GLACIER2_API AsyncSession : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = SessionPrx;
    ...
    /// @see SessionControlPrx
    /// @headerfile Glacier2/Glacier2.h
    class GLACIER2_API AsyncStringSet : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = StringSetPrx;
    ...
    /// @see SessionControlPrx
    /// @headerfile Glacier2/Glacier2.h
    class GLACIER2_API AsyncIdentitySet : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = IdentitySetPrx;
    ...
    /// @see SessionManagerPrx
    /// @headerfile Glacier2/Glacier2.h
    class GLACIER2_API AsyncSessionControl : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = SessionControlPrx;
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::SessionManager`.
    /// @headerfile Glacier2/Glacier2.h
    class GLACIER2_API AsyncSessionManager : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = SessionManagerPrx;
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Glacier2::SSLSessionManager`.
    /// @headerfile Glacier2/Glacier2.h
    class GLACIER2_API AsyncSSLSessionManager : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = SSLSessionManagerPrx;
