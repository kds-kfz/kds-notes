...
namespace Ice
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Ice::PropertiesAdmin`.
...
{
    /// Provides remote access to the properties of a communicator.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::PropertiesAdmin`.
    /// @headerfile Ice/Ice.h
...
namespace Ice
{
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::PropertiesAdmin`.
    /// @headerfile Ice/Ice.h
    class ICE_API AsyncPropertiesAdmin : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = PropertiesAdminPrx;
    ...
    using AsyncPropertiesAdminPtr = std::shared_ptr<AsyncPropertiesAdmin>;
}
