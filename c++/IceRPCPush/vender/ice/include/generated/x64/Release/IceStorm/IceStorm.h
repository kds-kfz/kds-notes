...
namespace IceStorm
{
    ...
    /// @see TopicPrx::subscribeAndGetPublisher
...
namespace IceStorm
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::IceStorm::Topic`.
    /// @see TopicManagerPrx
    ...
    public:
        ...
        /// @see ::IceStorm::TopicManagerPrx::create
        ...
        /// @see ::IceStorm::TopicPrx::unsubscribe
        ...
        /// @param context The request context.
        /// @see ::IceStorm::TopicPrx::subscribeAndGetPublisher
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::IceStorm::TopicManager`.
    /// @see TopicPrx
    /// @headerfile IceStorm/IceStorm.h
    ...
    public:
        ...
        /// @throws IceStorm::TopicExists Thrown when a topic with the same @p name already exists.
        ...
        /// @param context The request context.
        /// @return A proxy to the topic object. The returned proxy is never null.
        std::optional<TopicPrx> createOrRetrieve(std::string_view name, const Ice::Context& context = Ice::noExplicitContext) const; // NOLINT(modernize-use-nodiscard)
        ...
        /// @return A future that becomes available when the invocation completes. This future holds:
        /// - A proxy to the topic object. The returned proxy is never null.
        [[nodiscard]] std::future<std::optional<TopicPrx>> createOrRetrieveAsync(std::string_view name, const Ice::Context& context = Ice::noExplicitContext) const;
        ...
        /// @private
        void _iceI_createOrRetrieve(const std::shared_ptr<IceInternal::OutgoingAsyncT<std::optional<TopicPrx>>>&, std::string_view, const Ice::Context&) const;
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::IceStorm::Finder`.
    /// @headerfile IceStorm/IceStorm.h
...
namespace IceStorm
{
    ...
    /// @remarks The Slice compiler generated this struct from Slice struct `::IceStorm::LinkInfo`.
    /// @headerfile IceStorm/IceStorm.h
    struct LinkInfo
    {
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::IceStorm::LinkExists`.
    /// @headerfile IceStorm/IceStorm.h
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::IceStorm::NoSuchLink`.
    /// @headerfile IceStorm/IceStorm.h
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::IceStorm::AlreadySubscribed`.
    /// @headerfile IceStorm/IceStorm.h
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::IceStorm::BadQoS`.
    /// @headerfile IceStorm/IceStorm.h
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::IceStorm::TopicExists`.
    /// @headerfile IceStorm/IceStorm.h
...
namespace IceStorm
{
    /// Represents an IceStorm topic. Publishers publish data to a topic (via the topic's publisher object), and
    /// subscribers subscribe to a topic.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceStorm::Topic`.
    /// @see TopicManagerPrx
    /// @headerfile IceStorm/IceStorm.h
    ...
    /// Represents an object that manages topics.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceStorm::TopicManager`.
    /// @see TopicPrx
    /// @headerfile IceStorm/IceStorm.h
    ...
    public:
        ...
        /// @param current The Current object of the incoming request.
        /// @return A proxy to the topic object. The returned proxy is never null.
        virtual std::optional<TopicPrx> createOrRetrieve(std::string name, const Ice::Current& current) = 0;

        /// @private
        void _iceD_createOrRetrieve(Ice::IncomingRequest&, std::function<void(Ice::OutgoingResponse)>);
    ...
    /// Finder proxy `IceStorm/Finder:tcp -h somehost -p 4061` to get the TopicManager proxy
    /// `MyIceStorm/TopicManager:tcp -h somehost -p 4061`.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceStorm::Finder`.
    /// @headerfile IceStorm/IceStorm.h
...
namespace IceStorm
{
    ...
    /// @see TopicManagerPrx
    /// @headerfile IceStorm/IceStorm.h
    class ICESTORM_API AsyncTopic : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = TopicPrx;
    ...
    /// @see TopicPrx
    /// @headerfile IceStorm/IceStorm.h
    class ICESTORM_API AsyncTopicManager : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = TopicManagerPrx;
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceStorm::Finder`.
    /// @headerfile IceStorm/IceStorm.h
    class ICESTORM_API AsyncFinder : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = FinderPrx;
