...
namespace IceGrid
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::IceGrid::FileParser`.
    ...
    public:
        ...
        /// @param adminProxy An ::IceGrid::AdminPrx proxy, used only to retrieve default templates when needed. May be null.
...
namespace IceGrid
{
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::IceGrid::ParseException`.
    /// @headerfile IceGrid/IceGrid.h
...
{
    /// `icegridadmin` provides a `FileParser` object to transform XML files into ApplicationDescriptor objects.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceGrid::FileParser`.
    /// @headerfile IceGrid/IceGrid.h
...
namespace IceGrid
{
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::IceGrid::FileParser`.
    /// @headerfile IceGrid/IceGrid.h
    class ICEGRID_API AsyncFileParser : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = FileParserPrx;
