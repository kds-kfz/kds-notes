...
namespace Ice
{
    ...
    /// @remarks The Slice compiler generated this proxy class from Slice interface `::Ice::LocatorRegistry`.
    ...
    public:
        ...
        /// @param context The request context.
        /// @throws Ice::ServerNotFoundException Thrown when the locator does not know a server application with a server ID
        /// of @p id.
...
namespace Ice
{
    ...
    /// already active.
    /// @remarks The Slice compiler generated this exception class from Slice exception `::Ice::AdapterAlreadyActiveException`.
    /// @headerfile Ice/Ice.h
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::Ice::InvalidReplicaGroupIdException`.
    /// @headerfile Ice/Ice.h
    ...
    /// @remarks The Slice compiler generated this exception class from Slice exception `::Ice::ServerNotFoundException`.
    /// @headerfile Ice/Ice.h
...
{
    /// A server application registers the endpoints of its indirect object adapters with the LocatorRegistry object.
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::LocatorRegistry`.
    /// @headerfile Ice/Ice.h
...
namespace Ice
{
    ...
    /// @remarks The Slice compiler generated this skeleton class from Slice interface `::Ice::LocatorRegistry`.
    /// @headerfile Ice/Ice.h
    class ICE_API AsyncLocatorRegistry : public virtual Ice::Object
    {
    public:
        /// The associated proxy type.
        using ProxyType = LocatorRegistryPrx;
    ...
    using AsyncLocatorRegistryPtr = std::shared_ptr<AsyncLocatorRegistry>;
}
