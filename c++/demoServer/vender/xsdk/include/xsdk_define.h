...
#define xsdk_strncpy(p_pszDst, p_pszSrc, p_nSize) ((strlen(p_pszSrc) <= (p_nSize)) ? (strcpy((p_pszDst), (p_pszSrc))) : (strncpy((p_pszDst), (p_pszSrc), (p_nSize)) + ((p_pszDst[p_nSize -1] = 0x00) == 0x00 ? 0 : 0)))
#endif
