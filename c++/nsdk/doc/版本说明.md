...
## 2026-08-25 ClientData Token 秒级授权接口

- 新增 `BuildFeatrueByPlainClientInfoSeconds`，使用 UTC Unix 秒生成带明确有效期的 ClientData 授权码。
- nsdk 仅校验有效期为正数且时间计算不溢出，不写死 15 分钟或 30 天边界；`900~2592000` 秒完全由 TradingTerminal 应用业务层校验。
